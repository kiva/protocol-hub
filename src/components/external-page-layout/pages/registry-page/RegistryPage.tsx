...
import {DataGrid, ColDef, RowData, CellParams} from '@material-ui/data-grid';
...
const RegistryPage: FunctionComponent<Props> = () => {
  ...
  const [credentialData, setCredentialData] = useState<RowData[]>([]);
